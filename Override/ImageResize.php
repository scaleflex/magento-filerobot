...
namespace Scaleflex\Filerobot\Override;
...
use Magento\MediaStorage\Service\ImageResize as ParentImageResize;
 ...
 */
class ImageResize extends ParentImageResize
{
    /**
     * @var State
     */
    ...
    public function resizeFromThemes(array $themes = null, bool $skipHiddenImages = false): Generator
    {
        ...
        foreach ($productImages as $image) {
            ...
            if (!strpos($originalImagePath, 'https://')) {
                if ($this->mediaDirectory->isFile($originalImagePath)) {
                    try {
