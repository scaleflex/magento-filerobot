...
namespace Scaleflex\Filerobot\Block\Product;
...
use Magento\Catalog\Block\Product\ImageFactory as BaseImageFactory;
...
class ImageFactory extends BaseImageFactory
{
    ...
    public function __construct(
        ...
        $this->filerbotConfig = $filerobotConfig;
    }
    ...
    public function create(Product $product, string $imageId, array $attributes = null): ImageBlock
    {
        ...
        $template = $this->filerbotConfig->checkStatus() ? 'Scaleflex_Filerobot::product/image_with_borders.phtml'
